...
check:
	@. .venv/bin/activate && python3 -m flake8 app/ ${TARGET_TEST} ${TARGET_FUNCTIONAL_TEST} && deactivate
...
run:
	@. .venv/bin/activate && uvicorn app.main:app --reload --log-level debug && deactivate
